...
const CategoryItem: React.FC<CategoryItemProps> = ({
  ...
  return <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 flex items-center justify-between">
      {isEditing ? <div className="flex-1 space-y-3">
          ...
          <div className="flex space-x-2">
            ...
            <button onClick={() => deleteCategory(category.id)} className="p-1 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">
